//package com.example.lap3.Utils;
//
//import com.example.lap3.services.CustomUserDetailService;
...
//            Exception {
//        return http.csrf().disable().authorizeHttpRequests(auth -> auth.requestMatchers( "/static/css/**", "/static/js/**", "/", "/register","/error")
//                        .permitAll()
